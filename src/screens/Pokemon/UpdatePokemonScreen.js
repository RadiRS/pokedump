...
class UpdatePokemonScreen extends Component {
  ...
  render() {
    ...
    const { name, image_url, latitude, longitude } = this.state;
    const { type_ids } = this.state;
...
const mapStateToProps = ({ categories, types, user, error, pokemon }) => ({
